...
print('\033[1;32mBest Test Accuracy: {}% params C:{} \033[1;m' .format(round(best_test_accuracy, 3), best_test_params))

# Prediction for Best Accuracy
BestClf = svm.SVC(kernel='linear', decision_function_shape='ovo', C=best_test_params)
